...
(________(   
 `------' 
                              ...
                              ║    Layer 7    ║
               ╔══════════════╩════════╦══════╩══════════════╗
               ║   goat-bypass         ║   cloudflare-uam    ║
               ║   http-fuzz           ║   normal-bypass     ║
               ║   http-dstat          ║   cf-bypass         ║
               ║   autobypass          ║   https-bypass      ║
               ║   http-rand           ║   100up-bypass      ║
               ║   http-raw            ║   http-flood        ║
               ║   http-overflow       ║   http-get          ║
               ╚═══════════════════════╩═════════════════════╝
''')
...
(________(   
 `------' 
               ...
               ║   ovhamp              ║   r6-drop           ║
               ║   fivem-drop          ║   vse               ║
               ║   fortnite-fly        ║   \x1b[38;2;0;255;255mgame-crash        \x1b[38;2;0;212;14m║
               ╚═══════════════════════╩═════════════════════╝
''')
